...
export const inquilinoService = {
  ...
  registrarVisitante: async (data: { nombre_completo: string; documento_identidad: string; placa?: string; hora_esperada: string }) => { return await api.post('/inquilino/visitantes', data); },
